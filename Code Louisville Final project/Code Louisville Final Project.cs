    ...
    public partial class appName : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.EnemyLivingHere != null)
            {
                ...
                // Make a new Enemy, using the values from the standard Enemy in the World.Enemy list
                Enemy standardEnemy = World.EnemyByID(newLocation.EnemyLivingHere.ID);

                _currentEnemy = new Enemy(standardEnemy.ID, standardEnemy.Name, standardEnemy.MaximumDamage,
                    standardEnemy.RewardXP, standardEnemy.RewardGold, standardEnemy.CurrentHitPoints, standardEnemy.MaximumHitPoints);
        ...
        private void btnUsePotion_Click(object sender, EventArgs e)
        {
            ...
            // Enemy gets their turn to attack
